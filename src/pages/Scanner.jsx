...
import { Search, LogIn, LogOut, QrCode, List, Users, ArrowLeft } from 'lucide-react';
        ...
        <div className="p-4 space-y-3">
            <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white rounded-xl shadow-sm border border-gray-100 focus:border-blue-500 outline-none font-medium"
                />
            </div>
                    ...
                    <div key={student.id} onClick={() => processAttendance(student.id)} className="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex items-center justify-between active:bg-gray-50 transition-colors cursor-pointer">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className={`text-[10px] font-bold ${inside ? 'text-green-600' : 'text-gray-400'}`}>
                                    {inside ? 'CURRENTLY INSIDE' : 'AWAY'}
                                </p>
                            </div>
                        </div>
